...
export function renderSVG(avatar, opts = {}) {
  ...
  const vars = `--skin:${a.body.skin};--hair:${a.hair.color};--eye:${a.eyes.color};--mouth:${a.mouth.color};--top:${a.top.color};--top2:${a.top.color2 || '#ffffff'};--bottom:${a.bottom.color};--shoes:${a.shoes.color};--acc:${a.accessory.color};--hat:${a.hat.color};--extra:${a.extras.color};--cape:${a.cape.color};--cape-dark:${shade(a.cape.color, -0.25)};--held:${a.held.color};--held-dark:${shade(a.held.color, -0.3)};--offhand:${a.offhand.color};--offhand-dark:${shade(a.offhand.color, -0.3)};--decor:${a.decor.color};--decor-dark:${shade(a.decor.color, -0.3)};--skin-dark:${shade(a.body.skin, -0.18)};--hair-dark:${shade(a.hair.color, -0.2)};--top-dark:${shade(a.top.color, -0.18)};--bottom-dark:${shade(a.bottom.color, -0.18)};--shoes-dark:${shade(a.shoes.color, -0.25)}`;
  ...
  add('top', a.top, T.torso); add('cape', a.cape, T.torso); add('held', a.held, T.torso); add('offhand', a.offhand, T.torso); add('decor', a.decor, T.torso);
