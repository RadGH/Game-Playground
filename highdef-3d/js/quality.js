...
export const PRESETS = {
  ...
  high: {
    ...
    godRays: true,
    // Off by default even here. Screen-space occlusion means rendering the whole scene twice more
    // (once for depth, once for normals) and the model kits already bake occlusion into every
    // vertex, so the second pass buys much less than it costs. The panel switch turns it on.
    ssao: false,
    dof: false,
    smaa: true,
